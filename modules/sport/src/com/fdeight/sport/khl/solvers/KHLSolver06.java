...
public class KHLSolver06 implements KHLSolver {
    ...
    private static class Settings {
        /**
         * Доля баллов, которую одна команда отнимает у другой за победу в основное время.
         */
        public final double shareWinWithoutOvertime = 0.25;
        /**
         * Доля баллов, которую одна команда отнимает у другой за победу в овертайме или в серии бросков.
         */
